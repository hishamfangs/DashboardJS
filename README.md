...
Note: The HTML template with the appropriate CSS files and assets need to be present on the loading html page for the code above to run, which can be found here: [https://github.com/hishamfangs/DashboardJS/blob/main/dist/Simplest%20Example%20-%20No%20Configuration%20-%20Uses%20Current%20HTML%20file/index.html](index.html)

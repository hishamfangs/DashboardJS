...
Note: The HTML template with the appropriate CSS files and assets need to be present on the loading html page for the code above to run, which can be found here: [a relative link](dist/Simplest Example - No Configuration - Uses Current HTML file/index.html)
